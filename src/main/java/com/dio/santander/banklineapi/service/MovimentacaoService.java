...
public class MovimentacaoService {
	...
	public void save(NovaMovimentacao novaMovimentacao) {
		Movimentação movimentacao = new Movimentação(); 
		
		Double valor = novaMovimentacao.getTipo()==MovimentaçãoTipo.RECEITA ? novaMovimentacao.getValor() : novaMovimentacao.getValor() * -1;
